...
public class ImplHelper {
     ...
     * comparisons the original entity class should be used. Generated
     * subclass names are detected via {@link PCEnhancer#isPCSubclassName},
     * and superclasses are walked until a class that was not generated by
     * the enhancer is reached, so nested generated subclasses are unwrapped
     * as well.
     *
    ...
    public static Class<?> getEntityClass(Object obj) {
        ...
        while (cls != null && PCEnhancer.isPCSubclassName(cls.getName())) {
