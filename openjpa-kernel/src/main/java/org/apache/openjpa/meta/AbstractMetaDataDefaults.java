...
public abstract class AbstractMetaDataDefaults implements MetaDataDefaults {
    ...
    private boolean populateFromPCRegistry(ClassMetaData meta) {
        ...
        try {
            ...
            for (int i = 0; i < fieldNames.length; i ++) {
                ...
                else member = getBackingMethod(meta.getDescribedType(),
    ...
    private void populateFromReflection(ClassMetaData meta) {
        ...
        else members = meta.getDescribedType().getDeclaredMethods();
        int mods;
        String name;
        boolean def;
        FieldMetaData fmd;
    ...
    private Method getBackingMethod(Class cls, String name,
        Class methReturnType) throws NoSuchMethodException {
