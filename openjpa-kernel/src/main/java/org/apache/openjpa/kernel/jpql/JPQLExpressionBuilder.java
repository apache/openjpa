 ...
 * @nojavadoc
 */
class JPQLExpressionBuilder extends AbstractExpressionBuilder
    ...
    public JPQLExpressionBuilder(ExpressionFactory factory,
        ...
        contexts.push(new Context(parsedQuery instanceof ParsedJPQL
            ? (ParsedJPQL) parsedQuery : parsedQuery instanceof String
    ...
    private void evalQueryOperation(QueryExpressions exps) {
        ...
        else throw parseException(EX_UNSUPPORTED, "unrecognized-operation",
            new Object[]{ root() }, null);
    }
    ...
    private Expression evalSelectClause(QueryExpressions exps) {
        ...
        if (constructor != null) {
            ...
            else exps.distinct = exps.DISTINCT_FALSE;
            ...
            if (selectCount == 1 && selectChild != null &&
                ...
                onlyChild(selectChild) != null && assertSchemaAlias().
    ...
    private Expression evalFromClause(boolean needsAlias) {
        ...
        for (int i = 0; i < from.children.length; i++) {
            ...
            else throw parseException(EX_USER, "not-schema-name",
        ...
        switch (node.id) {
            ...
            case JJTINTEGERLITERAL:
                ...
                BigDecimal intlit = new BigDecimal
                    (node.text.endsWith("l") || node.text.endsWith("L")
                        ...
                        : node.text). multiply(new BigDecimal(negative(node)));
            ...
            case JJTIN: // x.field [NOT] IN('a', 'b', 'c')
                ...
                while (inIterator.hasNext()) {
                    ...
                    else inExp = factory.or(inExp, factory.equal(val1, val2));
                }
            ...
            case JJTLIKE: // field LIKE '%someval%'
                ...
                else return factory.matches(val1, val2, "_", "%", escape);
            case JJTISEMPTY:
            ...
            case JJTTRIM: // TRIM([[where] [char] FROM] field)
                ...
                else trimChar = factory.newLiteral(" ", Literal.TYPE_STRING);
    ...
    private Path getPath(JPQLNode node, boolean pcOnly, boolean inner) {
        ...
        else throw parseException(EX_USER, "path-no-meta",
    ...
    static class ParsedJPQL implements Serializable {
