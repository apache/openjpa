...
public class MKEDepartment implements java.io.Serializable {
    ...
    private int id;
    private String name;
    private Map<MKEOffices, MKEEmployee> lastNameEmployees;
    ...
    public Map<MKEOffices, MKEEmployee> getLastNameEmployees() {
        return lastNameEmployees;
    }

    public void setLastNameEmployees(Map<MKEOffices, MKEEmployee> lastNameEmployees) {
