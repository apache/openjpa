...
CREATE TABLE CONJOINPC4 (ID INTEGER NOT NULL, MANYTOMANY IMAGE, NAME VARCHAR(50), ONETOONE1_ID INTEGER, CONSTRAINT SQL150111133630400 PRIMARY KEY (ID));
...
CREATE TABLE EAGEROUTERJOINPC (ID BIGINT NOT NULL, NAME VARCHAR(255), HELPER IMAGE, CONSTRAINT SQL150111133630460 PRIMARY KEY (ID));
...
CREATE TABLE HELPERPC (ID INTEGER NOT NULL, STRNGFLD VARCHAR(50), EAGER_ID INTEGER, HELPER IMAGE, CONSTRAINT SQL150111133630500 PRIMARY KEY (ID));
